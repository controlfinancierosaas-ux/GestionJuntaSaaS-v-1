              ...
              <div>
                ...
                <div className="relative">
                  <input 
                    type="text" 
                    required 
                    value={formatDateForInput(nuevaReserva.fecha_evento)} 
                    className="w-full bg-neutral-800 p-3 pr-10 rounded-lg text-white" 
                    placeholder="dd/mm/yyyy" 
                    onChange={e => setNuevaReserva({...nuevaReserva, fecha_evento: parseDateFromUI(e.target.value)})} 
                  />
                  <input 
                    type="date" 
                    required 
                    value={nuevaReserva.fecha_evento} 
                    className="absolute right-3 top-1/2 -translate-y-1/2 w-6 h-6 opacity-0 cursor-pointer z-10" 
                    onChange={e => setNuevaReserva({...nuevaReserva, fecha_evento: e.target.value})} 
                  />
